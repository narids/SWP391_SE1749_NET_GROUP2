                                        ...
                                        <li class="action-card col-lg-6 col-md-6 col-sm-12 happening">
                                            <div class="event-bx m-b30">
                                                <div class="action-box">
                                                    <img src="${n.getThumbnail()}" alt="">
                                                </div>
                                                <div class="info-bx d-flex">

                                                    <div class="event-info">
                                                        <h4 class="event-title"><a href="news-display-detail?newsId=${n.newsId}">${n.getTitle()}</a></h4>
                                                        <ul class="media-post">
                                                            <li><a href="#"><i class="fa fa-clock-o"></i>${n.getCreatedDay()}</a></li>
                                                            <li><a href="#"><i class="fa fa-map-marker"></i> ${n.getCreatedBy()}</a></li>
                                                        </ul>
                                                        <p>${n.getSummary()}</p>
                                                    </div>
                                                </div>
