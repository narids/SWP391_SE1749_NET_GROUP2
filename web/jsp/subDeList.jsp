<%-- 
    Document   : subDeList
    Created on : Mar 7, 2024, 11:56:09 PM
    Author     : User
--%>
...
<html>
    ...
    <body id="bg">
        <div class="page-wraper">
            ...
            <div class="page-banner ovbl-dark" style="background-image:url(assets/images/banner/banner1.jpg);">
                <div class="container">
                    <div class="page-banner-entry">
                        <h1 class="text-white">Subject Dimension</h1>
                    </div>
                </div>
            </div>
            <!-- Breadcrumb row -->
            ...
            <div>
                <a href="addsubdi" class="btn btn-sm info ">
                    Add a Subject Dimension
                </a>
            </div>
            <div class="courses-filter">
                <div class="clearfix">
                    <ul id="masonry" class="ttr-gallery-listing magnific-image row">
                        <c:forEach items="${requestScope.subdelist}" var="ab">
                        ...
                        <form action="subdelist" method="post">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="deleteModalLabel">Delete Subject Dimension</h5>
