...
<html lang="en">
    ...
    <head>
        ...
        <script>
            ...
            var timeRemaining = ${quiz.time}; // 10 minutes in seconds
                ...
                <div class="breadcrumb-row">
                    <div class="container">
                        <ul class="list-inline">
                            ...
                            <li><a href="quiz">Quiz Handle</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Breadcrumb row END -->
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <c:forEach items="${adao.getAnswerByQuestion(q.questionId)}" var="a">
                                                                <div class="form-check">
                                                                    <input name="answers" class="form-check-input" type="checkbox" value="${a.answerId}" id="defaultCheck${a.answerId}">
