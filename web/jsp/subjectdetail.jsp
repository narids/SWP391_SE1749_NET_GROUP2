<%-- 
    ...
    Created on : Mar 12, 2024, 8:43:51 PM
    Author     : User
--%>
                            ...
                            <form action="subjectdetail" method="POST" >
                                <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <div>
                                            <textarea name="subdetail" class="form-control" style="width: 100%; min-height: 100px" required >${subjectdetail.subDetail}</textarea>
                                        </div>
                                    </div>
