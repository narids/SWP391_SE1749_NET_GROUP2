                            ...
                            <div class="menu-links navbar-collapse collapse justify-content-start" id="menuDropdown">
                                ...
                                <ul class="nav navbar-nav">
                                    <li class="active"><a href="javascript:;">Home <i class="fa fa-chevron-down"></i></a>
                                        <ul class="sub-menu">
                                            <li><a href="${pageContext.request.contextPath}">Home 1</a></li>
                                    ...
                                    <li class="nav-dashboard"><a href="javascript:;">Dashboard <i
                                                class="fa fa-chevron-down"></i></a>
                                        <ul class="sub-menu">
                                            <li><a href="admin/${pageContext.request.contextPath}">Dashboard</a></li>
                ...
                <div class="page-banner ovbl-dark" style="background-image:url(assets/images/banner/banner2.jpg);">
                    <div class="container">
                        <div class="page-banner-entry">
                            <h1 class="text-white">${quiz.quizName}</h1>
                        </div>
                    </div>
                </div>
                <!-- Breadcrumb row -->
                <div class="breadcrumb-row">
                    <div class="container">
                        <ul class="list-inline">
                            ...
                            <li><a href="quiz">Quiz Review</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Breadcrumb row END -->
                                    ...
                                    <div class="course-detail-bx">
                                        ...
                                        <div class="teacher-bx">
                                            <c:forEach items="${ltQuestion}" var="q1">
                                                <c:if test="${adao.isQuestionCorrect(selectedAnswers, q1.questionId) eq true}">
                                                    <% i++; %>
                                                </c:if>
                                            </c:forEach>
                                        ...
                                        <div style="margin-top: 10px" class="scroll-page">
                                            ...
                                            <c:forEach items="${ltQuestion}" var="q">
                                                <a 
                                                    ...
                                                    class="${adao.isQuestionCorrect(selectedAnswers, q.questionId) eq true ? 'bg-green' : 'bg-red'} nav-link" 
                                                    style="margin: 4px; padding: 6px 12px; width: 35px; height: 35px; display: inline-block" 
                                                    id="navBtn${q.questionId}">
                                                    <%= i %>
                                                </a>
                                                <% i++; %>
                                            </c:forEach>
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-12">
                                    <div class="row">
                                        <form id="quizForm" action="quiz-handle" method="post" class="w-100">
                                            ...
                                            <% i = 1; %>
                                            <c:forEach items="${ltQuestion}" var="q">
                                                <div class="col-lg-12 mb-3" id="question${q.questionId}">
                                                    <div class="card">
                                                            ...
                                                            <c:forEach items="${adao.getAnswerByQuestion(q.questionId)}" var="a">
                                                                <div class="form-check">
                                                                    ...
                                                                    <c:forEach items="${selectedAnswers}" var="selectedAnswerId">
                                                                        <c:if test="${selectedAnswerId == a.answerId}">
                                                                    ...
                                                                    <input 
                                                                        ...
                                                                        type="checkbox" 
                                                                        value="${a.answerId}" 
                                                                        id="defaultCheck${a.answerId}"
                                                                        disabled
                                                                        ${checked}
                                                                        >
                                                                    <label class="form-check-label" style="font-weight: 400;" for="defaultCheck${a.answerId}">
                                                                        ${a.answerContent}
                                                                    </label>
                                                                </div>
                                                            </c:forEach>
                                                    ...
                                                    <div class="alert alert-warning mt-2" role="alert">
                                                        <p class="p-0 m-0">
                                                            Correct Answers: 
                                                            <c:forEach items="${adao.getAnswerByQuestion(q.questionId)}" var="as">
                                                                <c:if test="${as.isCorrect eq true}">
                                                                    ${as.answerContent} 
                                                                </c:if>
                                                            </c:forEach>
                                                        </p>
                                                        <p class="p-0 m-0">${q.explain}</p>
                                                    </div>
                                                </div>
                                                <% i++; %>
                                            </c:forEach>
