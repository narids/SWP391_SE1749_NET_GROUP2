<%-- 
    Document   : addques
    Created on : Feb 28, 2024, 10:06:15 AM
    Author     : User
--%>
                                        ...
                                        <ul class="sub-menu add-menu">
                                            <li class="add-menu-left">
                                                ...
                                                <ul>
                                                    ...
                                                    <li> <c:if test="${sessionScope.user.getRole().getRoleId()==3}" > 
                ...
                <div class="page-banner ovbl-dark" style="background-image:url(assets/images/banner/banner1.jpg);">
                    <div class="container">
                        <div class="page-banner-entry">
                            <h1 class="text-white">Add Question</h1>
                        </div>
                    </div>
                </div>
                <!-- Breadcrumb row -->
                                ...
                                <form action="addques" method="POST" class="edit-profile m-b30"  enctype="multipart/form-data" onsubmit="getContent()">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-12">
                                            <label class="col-form-label">Explain <span class="text-red">*</span></label>
                                            <div>
                                                <textarea name="explain" class="form-control" style="width: 100%; min-height: 100px" required></textarea>
                                            </div>
                                        </div>
                                        
                                        <div class="col-12">
                                            <button name="submit" id="AddQuesButton" type="submit" value="Submit" class="btn button-md">Add</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
