...
<html lang="en">
    ...
    <body id="bg">
        <%
           ...
           MyClass classSelected = (MyClass) request.getAttribute("classname");
        %>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-lg-4">
                                                <ul class="course-features">
                                                    <li><i class="ti-book"></i> <span class="label">Classname</span> 
                                                        <span class="value"><%= (classSelected != null) ? classSelected.getClassName() : "Class not found" %></span>
                                                    </li>
