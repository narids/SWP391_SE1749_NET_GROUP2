                                    ...
                                    <div class="col-lg-12 m-b30">
                                        <div class="widget-box">
                                            ...
                                            <div class="widget-inner">
                                                <form id="ClassForm" class="edit-profile m-b30" enctype="multipart/form-data" action="ClassDetail" method="post">
                                                    <div class="row">
                                                        <div class="form-group col-8">
                                                            <input name="ClassId" class="form-control" type="hidden" value="${classSelected.getClassID()}" required>
                                                            ...
                                                            <select name="TeacherID" class="form-control" required>
                                                                ...
                                                                <option value="${TeacherID}" ${TeachID == null || !teacherIDs.contains(TeacherID) ? 'selected' : ''}>${TeacherID}</option>
                                                            </select>
